...
CREATE TABLE IF NOT EXISTS measure_units_sets
(
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY
);

CREATE TABLE IF NOT EXISTS measure_units_distribution
(
    set_id bigint REFERENCES measure_units_sets,
    unit_id bigint REFERENCES measure_units,
...
(
    ...
    set_id bigint NOT NULL REFERENCES measure_units_sets
);
